...
def list2df(list, index_col=None, set_caption=None, return_df=True,df_kwds=None,
            caption=None): #, sort_values='index'):
...
# #     import types
# #     if score_fn is None:
# #         score_func = make_scorer(my_custom_scorer)
